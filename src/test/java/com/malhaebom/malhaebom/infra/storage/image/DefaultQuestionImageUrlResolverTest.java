...
class DefaultQuestionImageUrlResolverTest {
	...
	void 상대_경로에_base_url을_붙인다() {
		DefaultQuestionImageUrlResolver resolver = createResolver(BASE_URL);
	...
	void 이미_완성된_URL은_그대로_반환한다() {
		DefaultQuestionImageUrlResolver resolver = createResolver(null);
	...
	private DefaultQuestionImageUrlResolver createResolver(String baseUrl) {
